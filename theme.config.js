...
export default {
  projectLink: "https://github.com/plottwist-hu/plottwist.hu",
  docsRepositoryBase:
    "https://github.com/plottwist-hu/plottwist.hu/blob/master/pages",
  titleSuffix: " – Plot Twist",
  search: false,
  logo: () => {
    ...
    return (
      <>
        ...
        <meta
          ...
          content={
            meta.description ||
            "Plot Twist is a software consultancy providing a wide range of digital services including strategy, design, engineering, marketing, project management and quality assurance."
          }
        />
        <meta
          name="og:description"
        ...
        <meta
          name="og:title"
          content={title ? title + " – Plot Twist" : "Plot Twist"}
        />
        <meta name="og:image" content={ogImage} />
        <meta name="apple-mobile-web-app-title" content="Plot Twist" />
      </>
    );
  },
  ...
  footerText: ({ locale }) => {
    return (
      <span className="inline-flex items-center no-underline text-current font-semibold">
        Copyright {new Date().getFullYear()} © Plot Twist Kft.
      </span>
    );
  },
  i18n: [
